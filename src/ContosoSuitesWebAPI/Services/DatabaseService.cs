...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings for a single hotel by Minimum Date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, [Description("The Minimum Dates")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all bookings bookings with more than one hotel room.")]
